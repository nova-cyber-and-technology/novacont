...
/**
 * TODO(VERIFY): Replace with the real, currently-deployed contract addresses.
 * The README (./README.md at the repo root) is the source of truth, keep this in sync with it,
 * never the other way around, this file has no way to verify itself against what's actually deployed.
 */
